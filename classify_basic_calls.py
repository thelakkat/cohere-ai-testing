...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug 12 02:19:02 2023
...
co = cohere.Client('XCnujcrDPbQwhNi61lELCZrpjaevxZQK2wL3S0O1')
...
#print(response) Going to try to use a json package to make the output look cleaner
